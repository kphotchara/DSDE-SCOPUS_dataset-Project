...
class NetworkVisualizer:
    def __init__(self, G: nx.Graph):
        self.G = G
        self.colors = [
            "#eb9da2", "#acbbe8", "#bbe8b5", "#4363d8", "#f58231", 
...
def main():
    st.set_page_config(page_title="Subject Area Network Analysis", layout="wide")
    
    st.title("Subject Area Network Analysis")
    ...
    with tab_viz:
        ...
        with st.sidebar:
            G = nx.read_gml('subject_name_network.gml')
